// Standard easing functions (dedicated CSS keyword)
...
// Extra easing-in functions
export const easeInQuad = "cubic-bezier(0.55, 0.085, 0.680, 0.53)";
